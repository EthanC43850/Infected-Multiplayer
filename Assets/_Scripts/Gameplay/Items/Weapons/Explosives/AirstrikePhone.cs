...
public class AirstrikePhone : Explosive
{
    ...
    private void SummonAirstrike()
    {
        ...
        else
        {
            ...
            AirstrikeMissileProjectileBehavior airStrike = Instantiate(missileObject, airStrikeIndicator.transform.position + missileHeightOffset, Quaternion.identity).GetComponent<AirstrikeMissileProjectileBehavior>();
