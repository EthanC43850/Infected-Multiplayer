...
public class PlayerController : Targetable, IDamageable
{
    ...
    public void TakeDamage(int damage)
    {
        ...
        {
            // Signals to all that this specific PV owner is taking damage, (The shooter runs this call)
    ...
    public void RPC_TakeDamage(int damage, PhotonMessageInfo info)
    {
        ...
        if (currentHealth <= 0)
        {
            ...
            // Find the playermanager associated with the player who sent this RPC, then call getkill on this playermanager;
    ...
    } // END ToggleScoreboard


    //-------------------------------------------//
    public void ToggleMainMenu(InputAction.CallbackContext value)
    {
        if (Cursor.visible)
        {
